...
export const Guess = ({ stage }: { stage: QuestionProps }) => {
  return (
    <ScrollView
      ...
      <View className="h-36 my-8">
        <TextField variant="underlined" placeholderTx="placeholder.guess" keyboardType="numeric" />
        <Button tx="common.guess" className="h-12" />
      </View>
    </ScrollView>
  )
}
